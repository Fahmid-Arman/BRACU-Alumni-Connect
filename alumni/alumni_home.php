<?php
require_once(__DIR__ . '/../includes/fetch_alumni.php'); // Fetch alumni data
  ...
  <div class="page">
    <header class="glass hdr">
      ...
      <nav class="links">
        ...
        <a href="/alumni/connection_requests.php"><i class='bx bx-link'></i><span>Requests</span></a>
        <a href="/alumni/alumni_search.php"><i class='bx bx-search'></i><span>Search</span></a>
    ...
    <section class="glass card quick-links-card">
      ...
      <div class="quick-links-grid">
        <a href="/alumni/alumni_search.php" class="quick-link-btn">Search Students</a>
        <a href="/shared/inbox.php" class="quick-link-btn">Inbox</a>
        <a href="/alumni/connection_requests.php" class="quick-link-btn">Received Requests</a>
        <a href="/alumni/edit_alumni_profile.php" class="quick-link-btn">Edit Profile</a>
      </div>
    </section>
