...
<div class="page">
    <header class="glass hdr">
        ...
        <nav class="links">
            ...
            <a href="/student/student_search.php"><i class='bx bx-arrow-back'></i><span>Back to Search</span></a>
                    ...
                    <?php foreach ($search_results as $row): ?>
                        ...
                        <div class="search-result-item">
                            ...
                            <div class="result-actions">
                                <a href="/shared/view_alumni_profile.php?user_id=<?php echo e($row['user_id']); ?>" class="btn">View Profile</a>
                                <a href="/shared/inbox.php?to=<?php echo e($row['user_id']); ?>" class="btn">Message</a>
                                <?php if ($show_connect_button): ?>
                                    <form method="POST" action="/shared/send_connection_request.php" class="inline-action-form">
