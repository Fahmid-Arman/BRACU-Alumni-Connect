...
$cv_url = public_file_path($student_data['cv'] ?? '');
?>
    ...
    <section class="dash">
      <section class="glass card profile">
        <div class="profile-content">
          ...
          <div class="info">
            ...
            <div class="grid-info">
              ...
              <div class="row"><span>CV</span><strong><?php if ($cv_url): ?><a href="<?php echo e($cv_url); ?>" target="_blank" rel="noopener noreferrer">View CV</a><?php else: ?>Not provided<?php endif; ?></strong></div>
        ...
        <div class="edit-btn-container">
          <a href="/student/edit_student_profile.php" class="btn edit-btn">Edit Profile</a>
        </div>
      </section>
    </section>
  </div>
