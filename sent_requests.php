                    ...
                    <?php foreach ($requests as $request): ?>
                        <div class="search-result-item">
                            ...
                            <div class="result-actions">
                                <a href="view_alumni_profile.php?user_id=<?php echo e($request['alumni_user_id']); ?>" class="btn">View Profile</a>
                                <a href="inbox.php?to=<?php echo e($request['alumni_user_id']); ?>" class="btn">Message</a>
                                <?php if ($request['status'] === 'pending'): ?>
                                    <form method="POST" action="cancel_connection_request.php" class="inline-action-form">
