...
$back_path = $viewer_role === 'student' ? 'student_search.php' : 'admin_home.php';
    ...
    <section class="dash">
      <section class="glass card profile">
        ...
        <?php else: ?>
              ...
              <?php if ($viewer_role === 'student'): ?>
                <section class="request-panel">
                  ...
                  <?php if ($can_send_request): ?>
                    <form method="POST" action="send_connection_request.php" class="request-panel-form">
                      <input type="hidden" name="csrf_token" value="<?php echo e(csrf_token()); ?>">
                      <input type="hidden" name="alumni_id" value="<?php echo e($alumni_profile['user_id']); ?>">
                      <input type="hidden" name="return_to" value="<?php echo e($_SERVER['REQUEST_URI'] ?? ('view_alumni_profile.php?user_id=' . $alumni_profile['user_id'])); ?>">
          ...
          <div class="profile-actions">
            <a href="inbox.php?to=<?php echo e($alumni_profile['user_id']); ?>" class="btn edit-btn">Message</a>
            <a href="<?php echo e($back_path); ?>" class="btn edit-btn"><?php echo e($back_label); ?></a>
          </div>
        <?php endif; ?>
      </section>
