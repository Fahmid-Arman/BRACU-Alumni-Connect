...
<body>
  <div class="page">
    <header class="glass hdr">
      ...
      <nav class="links">
        <a href="/admin/add_event.php"><i class='bx bx-calendar-plus'></i><span>Add Event</span></a>
    ...
    <section class="glass card quick-links-card">
      ...
      <div class="quick-links-grid">
        <a href="/admin/add_event.php" class="quick-link-btn">Add Event</a>
    ...
    <section class="dash">
          ...
          <?php if ($result && mysqli_num_rows($result) > 0): ?>
            <?php while ($user = mysqli_fetch_assoc($result)): ?>
              ...
              if ($user['role'] === 'student') {
                  $view_profile_path = '/shared/view_student_profile.php?user_id=' . (int) $user['user_id'];
              } elseif ($user['role'] === 'alumni') {
                  $view_profile_path = '/shared/view_alumni_profile.php?user_id=' . (int) $user['user_id'];
              }
              ?>
              <li class="user-item">
      ...
      <section class="glass card events" id="events-section">
        <div class="section-head">
          ...
          <a href="/admin/add_event.php" class="btn-add">Add Event</a>
        </div>
            ...
            <?php while ($event = mysqli_fetch_assoc($events_result)): ?>
              <li>
                ...
                <div class="event-actions">
                  <a href="/admin/edit_event.php?event_id=<?php echo e($event['event_id']); ?>" class="btn-edit">Edit</a>
                  <form method="POST" action="/admin/delete_event.php">
