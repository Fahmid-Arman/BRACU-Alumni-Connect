  ...
  <div class="page">
    <header class="glass hdr">
      ...
      <nav class="links">
        ...
        <a href="sent_requests.php"><i class='bx bx-link'></i><span>Sent Requests</span></a>
    ...
    <section class="glass card quick-links-card">
      ...
      <div class="quick-links-grid">
        <a href="student_search.php" class="quick-link-btn">Search Alumni</a>
        <a href="inbox.php" class="quick-link-btn">Inbox</a>
        <a href="sent_requests.php" class="quick-link-btn">Sent Requests</a>
        <a href="edit_student_profile.php" class="quick-link-btn">Edit Profile</a>
      </div>
    </section>
