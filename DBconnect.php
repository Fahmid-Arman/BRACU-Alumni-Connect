...
if ($conn->connect_error) {
    $message = 'Database connection failed. Check the database settings in DBconnect.php or the DB_HOST, DB_PORT, DB_NAME, DB_USER, and DB_PASS environment variables.';
